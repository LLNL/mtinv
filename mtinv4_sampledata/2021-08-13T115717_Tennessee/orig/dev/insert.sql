...
VALUES ( 
 ...
 (SELECT max(mtorid) FROM mtorid_seq), 
    -2.55e+14, -4.21e+14, 6.76e+14, 4.17e+13, 1.36e+15, 4.47e+14, 
 'DEVMT', 1.72e+22,     4.09,   0,  50,  50,     0.00, -999.00,    0.250,    0.0000, 
  83.98, 1.10e-10, 'mtinv4.0.1:5', 'Y', 'N', 'N', 'ichinose1', CURRENT_TIMESTAMP ); 
...
( (SELECT   max(fpid) FROM fpid_seq), 
  (SELECT max(mtorid) FROM mtorid_seq), 
 'MT', 'MAJORDC',   293,  9,   95,   109, 81,   89, 
  1.72, 18, 54,  -1.72, 199, 36,   0.00, 109, 1, 
 'ichinose1', 1.71656e+22, 3.753e+14, 8.57328e+21, CURRENT_TIMESTAMP ); 


INSERT into MT_ORIGIN_STAGE 
 ( lat, lon, depth, time, orid, evid, jdate, algorithm, auth, lddate )
VALUES
 ( 35.8767, -84.898, 1, 1628855855.000000, 
  (SELECT max(mtorid) FROM mtorid_seq), 
  -1, 2021225, 'mtinv4.0.1:5', 'ichinose1', CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  18, -0.3, 1, 'N', -1, 0.163849, 0.76, 84.0, 207, 26, 0.05, 'Y',  8.8893, 0.990497, 0, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.3, 1, 'N', -1, 0.163849, 0.76, 84.0, 207, 26, 0.05, 'Y',  11.6985, 0.947409, 0.05, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.3, 1, 'N', -1, 0.163849, 0.76, 84.0, 207, 26, 0.05, 'Y',  3.15847, 0.744047, 1.8, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.1, 1, 'N', -1, 0.163849, 0.94, 104.2, 103, 284, 0.05, 'Y',  28.5614, 0.9916, 0, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.1, 1, 'N', -1, 0.163849, 0.94, 104.2, 103, 284, 0.05, 'Y',  11.869, 0.857559, 9.6, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.1, 1, 'N', -1, 0.163849, 0.94, 104.2, 103, 284, 0.05, 'Y',  9.32647, 0.873625, 2.9, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.5, 1, 'N', -1, 0.163849, 0.95, 106.0, 312, 132, 0.05, 'Y',  20.662, 0.996267, 0, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.5, 1, 'N', -1, 0.163849, 0.95, 106.0, 312, 132, 0.05, 'Y',  6.87597, 0.820128, 9.5, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.5, 1, 'N', -1, 0.163849, 0.95, 106.0, 312, 132, 0.05, 'Y',  6.17193, 0.891746, -10.6, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.42, 1, 'N', -1, 0.155986, 1.11, 123.6, 134, 315, 0.06, 'Y',  11.595, 0.988156, 0, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.42, 1, 'N', -1, 0.155986, 1.11, 123.6, 134, 315, 0.06, 'Y',  12.9324, 0.968427, -0.24, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.42, 1, 'N', -1, 0.155986, 1.11, 123.6, 134, 315, 0.06, 'Y',  1.6083, 0.640578, 10.38, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, 0.12, 1, 'N', -1, 0.155986, 1.14, 127.2, 2, 182, 0.06, 'Y',  22.2076, 0.983537, 0, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, 0.12, 1, 'N', -1, 0.155986, 1.14, 127.2, 2, 182, 0.06, 'Y',  13.9158, 0.870812, 0.12, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, 0.12, 1, 'N', -1, 0.155986, 1.14, 127.2, 2, 182, 0.06, 'Y',  1.29933, 0.448783, 9.18, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.35, 1, 'N', -1, 0.155986, 1.28, 141.8, 58, 239, 0.07, 'Y',  7.60868, 0.985341, 0, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.35, 1, 'N', -1, 0.155986, 1.28, 141.8, 58, 239, 0.07, 'Y',  14.7071, 0.923133, -0.21, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.35, 1, 'N', -1, 0.155986, 1.28, 141.8, 58, 239, 0.07, 'Y',  3.66039, 0.899575, -1.54, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.07, 1, 'N', -1, 0.155986, 1.31, 145.7, 179, 359, 0.07, 'Y',  8.57555, 0.97107, -0.07, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.07, 1, 'N', -1, 0.155986, 1.31, 145.7, 179, 359, 0.07, 'Y',  11.6366, 0.978074, 0, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.07, 1, 'N', -1, 0.155986, 1.31, 145.7, 179, 359, 0.07, 'Y',  2.53154, 0.662161, -14.56, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.07, 1, 'N', -1, 0.155986, 1.57, 174.0, 266, 84, 0.07, 'Y',  47.8155, 0.976416, 0, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.07, 1, 'N', -1, 0.155986, 1.57, 174.0, 266, 84, 0.07, 'Y',  8.72511, 0.972998, 0.21, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.07, 1, 'N', -1, 0.155986, 1.57, 174.0, 266, 84, 0.07, 'Y',  2.99636, 0.535679, 15.26, 'FK',  CURRENT_TIMESTAMP ); 
