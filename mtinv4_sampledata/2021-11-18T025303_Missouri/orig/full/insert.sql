...
VALUES ( 
 ...
 (SELECT max(mtorid) FROM mtorid_seq), 
    1.29e+15, -7.32e+14, -5.75e+13, -8.98e+14, 4.40e+14, 4.21e+14, 
 'FULLMT', 1.67e+22,     4.09,  10,   3,  88,     0.10, -999.00,    0.014,    9.0699, 
  86.52, 3.48e-10, 'mtinv4.0.1:6', 'Y', 'N', 'N', 'ichinose1', CURRENT_TIMESTAMP ); 
...
( (SELECT   max(fpid) FROM fpid_seq), 
  (SELECT max(mtorid) FROM mtorid_seq), 
 'MT', 'FULLMT',    26, 66, -169,   292, 80,  -24, 
  1.67, 341, 9,  -1.32, 247, 24,   0.14, 91, 64, 
 'ichinose1', 1.50503e+22, 1.65936e+21, 1.46211e+22, CURRENT_TIMESTAMP ); 
...
VALUES
 ( 36.9077, -90.543, 14, 1637203984.000000, 
  (SELECT max(mtorid) FROM mtorid_seq), 
  -1, 2021322, 'mtinv4.0.1:6', 'ichinose1', CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  18, -0.5, 1, 'N', -1, 0.155986, 0.81, 89.6, 61, 241, 0.05, 'Y',  9.74762, 0.993932, 0, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.5, 1, 'N', -1, 0.155986, 0.81, 89.6, 61, 241, 0.05, 'Y',  7.72792, 0.96989, 0.1, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.2, 1, 'N', -1, 0.155986, 0.86, 96.1, 122, 302, 0.05, 'Y',  10.4277, 0.958214, -0.25, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.2, 1, 'N', -1, 0.155986, 0.86, 96.1, 122, 302, 0.05, 'Y',  4.10101, 0.904234, 0.55, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.2, 1, 'N', -1, 0.155986, 0.86, 96.1, 122, 302, 0.05, 'Y',  16.5638, 0.990724, 0, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.3, 1, 'N', -1, 0.155986, 0.88, 97.6, 102, 283, 0.05, 'Y',  7.64624, 0.961849, 0.45, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.3, 1, 'N', -1, 0.155986, 0.88, 97.6, 102, 283, 0.05, 'Y',  20.8989, 0.969444, 0.5, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.3, 1, 'N', -1, 0.155986, 0.88, 97.6, 102, 283, 0.05, 'Y',  16.3209, 0.978499, 0, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.6, 1, 'N', -1, 0.155986, 1.03, 114.8, 156, 336, 0.05, 'Y',  8.87019, 0.992962, 0, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.6, 1, 'N', -1, 0.155986, 1.03, 114.8, 156, 336, 0.05, 'Y',  12.6337, 0.965032, 0.5, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.6, 1, 'N', -1, 0.155986, 1.03, 114.8, 156, 336, 0.05, 'Y',  2.28497, 0.850995, -6.95, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.49, 1, 'N', -1, 0.148756, 1.28, 141.8, 334, 154, 0.07, 'Y',  26.5621, 0.985203, -0.07, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.49, 1, 'N', -1, 0.148756, 1.28, 141.8, 334, 154, 0.07, 'Y',  13.217, 0.986812, 0, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.49, 1, 'N', -1, 0.148756, 1.28, 141.8, 334, 154, 0.07, 'Y',  8.63307, 0.925083, -0.21, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.49, 1, 'N', -1, 0.148756, 1.28, 141.8, 334, 154, 0.07, 'Y',  26.5345, 0.985151, -0.07, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.49, 1, 'N', -1, 0.148756, 1.28, 141.8, 334, 154, 0.07, 'Y',  13.1824, 0.986677, 0, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.49, 1, 'N', -1, 0.148756, 1.28, 141.8, 334, 154, 0.07, 'Y',  8.62218, 0.925464, -0.14, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, 0.49, 1, 'N', -1, 0.148756, 1.33, 147.5, 52, 233, 0.07, 'Y',  12.9735, 0.9511, 0, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, 0.49, 1, 'N', -1, 0.148756, 1.33, 147.5, 52, 233, 0.07, 'Y',  6.98677, 0.817953, 0.49, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, 0.49, 1, 'N', -1, 0.148756, 1.33, 147.5, 52, 233, 0.07, 'Y',  12.0918, 0.949154, -0.28, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.24, 1, 'N', -1, 0.121914, 1.74, 193.9, 8, 188, 0.08, 'Y',  11.7748, 0.932151, 0.32, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.24, 1, 'N', -1, 0.121914, 1.74, 193.9, 8, 188, 0.08, 'Y',  24.4164, 0.941225, 0.32, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.24, 1, 'N', -1, 0.121914, 1.74, 193.9, 8, 188, 0.08, 'Y',  14.4728, 0.973841, 0, 'FK',  CURRENT_TIMESTAMP ); 
