...
################## ARLS ista = 1 ########################
###
gmt psbasemap -R0/54/-1428/1921 -JX1.5i/0.75i -Bxf14a54+l"sec" -Byf480a1921+l"nm" -BS -P -K -Vq >! gmtwf.000.ps
...
################## UCH ista = 3 ########################
###
gmt psbasemap -R0/54/-1498/1374 -JX1.5i/0.75i -Bxf14a54 -Byf344a1374+l"nm" -BS -Y1.25i -X-3i -O -K -Vq >> gmtwf.000.ps
...
echo "0 1374 Z" | gmt pstext -R -JX -D0.1i/0.0i -F+jBL+f14p,Times-Bold,black -N -O -K -Vq >> gmtwf.000.ps
...
echo "0 1374 R" | gmt pstext -R -JX -D0.1i/0.0i -F+jBL+f14p,Times-Bold,black -N -O -K -Vq >> gmtwf.000.ps
...
echo "0 1374 T" | gmt pstext -R -JX -D0.1i/0.0i -F+jBL+f14p,Times-Bold,black -N -O -K -Vq >> gmtwf.000.ps
...
################## CHM ista = 5 ########################
###
gmt psbasemap -R0/75/-956/791 -JX1.5i/0.75i -Bxf19a75 -Byf198a791+l"nm" -BS -Y1.25i -X-3i -O -K -Vq >> gmtwf.000.ps
...
echo "0 791 Z" | gmt pstext -R -JX -D0.1i/0.0i -F+jBL+f14p,Times-Bold,black -N -O -K -Vq >> gmtwf.000.ps
...
echo "0 791 R" | gmt pstext -R -JX -D0.1i/0.0i -F+jBL+f14p,Times-Bold,black -N -O -K -Vq >> gmtwf.000.ps
...
echo "0 791 T" | gmt pstext -R -JX -D0.1i/0.0i -F+jBL+f14p,Times-Bold,black -N -O -K -Vq >> gmtwf.000.ps
...
################## TKM2 ista = 7 ########################
###
gmt psbasemap -R0/108/-892/792 -JX1.5i/0.75i -Bxf27a108 -Byf198a792+l"nm" -BS -Y1.25i -X-3i -O -K -Vq >> gmtwf.000.ps
...
echo "0 792 Z" | gmt pstext -R -JX -D0.1i/0.0i -F+jBL+f14p,Times-Bold,black -N -O -K -Vq >> gmtwf.000.ps
...
echo "0 792 R" | gmt pstext -R -JX -D0.1i/0.0i -F+jBL+f14p,Times-Bold,black -N -O -K -Vq >> gmtwf.000.ps
...
echo "0 792 T" | gmt pstext -R -JX -D0.1i/0.0i -F+jBL+f14p,Times-Bold,black -N -O -K -Vq >> gmtwf.000.ps
...
5 5 6 0.925988 -1.15935 0.23336 -4.84061 6.00517 0.904159 21 x y 2009/12/22T05:54:38.00 Kambrata, Kyrgyzstan
EOF
...
9 8 2009/12/22T05:54:38.00
9 7 Depth =   6.0 @%7%km@%%
9 6 M@-w@- =  3.87
9 5 M@-0@- =  7.97@%12%\264@%%10@+14@+ N@%12%\264@%%m
9 4 DC=93% CLVD=7%
9 3 VR=  65.7%
9  2 M@-xx@-=-1.16 M@-xy@-=-0.90
9  1 M@-xz@-=-4.84 M@-yy@-=+0.23
9  0 M@-yz@-=-6.01 M@-zz@-=+0.93
9 -1 P1(S/D/R): 83/7/32
9 -2 P2(S/D/R): 321/86/96
EOF
