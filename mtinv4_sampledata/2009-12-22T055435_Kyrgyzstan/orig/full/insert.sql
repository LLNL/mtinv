...
VALUES ( 
 ...
 (SELECT max(mtorid) FROM mtorid_seq), 
    8.36e+14, 1.16e+15, 2.91e+15, 8.10e+13, -2.98e+14, 2.72e+12, 
 'FULLMT', 2.95e+22,     4.25,  55,  31,  14,     0.55, -999.00,    0.347,    0.8042, 
  74.46, 2.43e-10, 'mtinv4.0.1:6', 'Y', 'N', 'N', 'ichinose1', CURRENT_TIMESTAMP ); 
...
( (SELECT   max(fpid) FROM fpid_seq), 
  (SELECT max(mtorid) FROM mtorid_seq), 
 'MT', 'FULLMT',    76, 37,   87,   260, 53,   92, 
  2.95, 182, 82,   0.78, 348, 8,   1.18, 78, 2, 
 'ichinose1', 1.31719e+22, 1.63779e+22, 4.0421e+21, CURRENT_TIMESTAMP ); 

INSERT into MT_ORIGIN_STAGE 
 ( lat, lon, depth, time, orid, evid, jdate, algorithm, auth, lddate )
VALUES
 ( 41.7392, 73.377, 1, 1261461275.000000, 
  (SELECT max(mtorid) FROM mtorid_seq), 
  -1, 2009356, 'mtinv4.0.1:6', 'ichinose1', CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  18, -0.3, 1, 'N', -1, 0.160954, 0.72, 79.9, 80, 261, 0.05, 'Y',  34.9812, 0.936015, 0, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.3, 1, 'N', -1, 0.160954, 0.72, 79.9, 80, 261, 0.05, 'Y',  8.48345, 0.914744, 0.15, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.3, 1, 'N', -1, 0.160954, 0.72, 79.9, 80, 261, 0.05, 'Y',  6.34608, 0.766904, 3.35, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, 1.35, 1, 'N', -1, 0.160954, 0.97, 107.6, 18, 198, 0.05, 'Y',  25.6845, 0.911377, -0.3, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, 1.35, 1, 'N', -1, 0.160954, 0.97, 107.6, 18, 198, 0.05, 'Y',  14.496, 0.719943, -0.35, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, 1.35, 1, 'N', -1, 0.160954, 0.97, 107.6, 18, 198, 0.05, 'Y',  22.9362, 0.965695, 0, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -1.15, 1, 'N', -1, 0.160954, 0.98, 108.4, 60, 240, 0.05, 'Y',  67.9686, 0.93069, 0.95, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -1.15, 1, 'N', -1, 0.160954, 0.98, 108.4, 60, 240, 0.05, 'Y',  26.3857, 0.901657, 1, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -1.15, 1, 'N', -1, 0.160954, 0.98, 108.4, 60, 240, 0.05, 'Y',  13.8063, 0.955038, 0, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.07, 1, 'N', -1, 0.16085, 1.48, 164.6, 51, 232, 0.07, 'Y',  35.8255, 0.961412, 0, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.07, 1, 'N', -1, 0.16085, 1.48, 164.6, 51, 232, 0.07, 'Y',  12.6192, 0.955629, 0.14, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.07, 1, 'N', -1, 0.16085, 1.48, 164.6, 51, 232, 0.07, 'Y',  5.64707, 0.742371, -2.1, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -1.05, 1, 'N', -1, 0.128726, 1.62, 179.7, 38, 219, 0.07, 'Y',  59.1322, 0.932331, 0.91, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -1.05, 1, 'N', -1, 0.128726, 1.62, 179.7, 38, 219, 0.07, 'Y',  7.37698, 0.920245, 1.05, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -1.05, 1, 'N', -1, 0.128726, 1.62, 179.7, 38, 219, 0.07, 'Y',  11.2026, 0.974042, -0.07, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, 0.08, 1, 'N', -1, 0.128726, 1.74, 193.1, 28, 209, 0.08, 'Y',  16.9477, 0.889516, 0, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, 0.08, 1, 'N', -1, 0.128726, 1.74, 193.1, 28, 209, 0.08, 'Y',  30.5563, 0.704167, 0.16, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, 0.08, 1, 'N', -1, 0.128726, 1.74, 193.1, 28, 209, 0.08, 'Y',  16.1515, 0.755703, -0.24, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, 0, 1, 'N', -1, 0.128726, 2.02, 224.7, 53, 235, 0.1, 'Y',  85.6528, 0.967478, 0, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, 0, 1, 'N', -1, 0.128726, 2.02, 224.7, 53, 235, 0.1, 'Y',  26.951, 0.94741, 0.3, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, 0, 1, 'N', -1, 0.128726, 2.02, 224.7, 53, 235, 0.1, 'Y',  11.9411, 0.91607, -1.4, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.44, 1, 'N', -1, 0.128726, 2.19, 243.2, 76, 258, 0.11, 'Y',  53.7417, 0.975018, 0, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.44, 1, 'N', -1, 0.128726, 2.19, 243.2, 76, 258, 0.11, 'Y',  16.5912, 0.897636, 0.44, 'FK',  CURRENT_TIMESTAMP ); 
...
VALUES
 ( (SELECT max(mtwfsegid) FROM mtwfsegid_seq), 
  ...
  (SELECT max(mtfilterid) FROM mtfilterid_seq), 
  (SELECT max(mtvmodid) FROM mtvmodid_seq), 
  18, -0.44, 1, 'N', -1, 0.128726, 2.19, 243.2, 76, 258, 0.11, 'Y',  4.20454, 0.737983, -4.73, 'FK',  CURRENT_TIMESTAMP ); 
